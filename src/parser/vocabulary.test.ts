...
describe('Vocabulary', () => {
  ...
  describe('Unknown Word Handling', () => {
    it('should return UNKNOWN for unrecognized words', () => {
      expect(vocabulary.lookupWord('qwerty')).toBe(TokenType.UNKNOWN);
