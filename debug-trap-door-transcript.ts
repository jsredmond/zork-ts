...
/**
 * Debug script to analyze trap door transcript failures
 */
...
// Load the transcript
const transcript = JSON.parse(fs.readFileSync('.kiro/transcripts/critical/03-trap-door.json', 'utf-8'));

console.log('='.repeat(80));
console.log('TRAP DOOR TRANSCRIPT DEBUG');
console.log('='.repeat(80));
console.log();
